...
class download():
    def setUp(self):
        ...
        # 打开网址
        driver.get('https://www.qijizuopin.com/book/2009357')
        driver.implicitly_wait(5)
        driver.find_element(By.XPATH, value='//*[@id="__next"]/main/section[1]/section/section/section[2]/div[1]/div/div[2]/span').click()
        driver.implicitly_wait(5)
        # 获取章节名称和地址
        content = driver.find_element(By.XPATH, value='//*[@id="__next"]/main/section[1]/section/section/section[2]/div[2]/div[2]/div/div/div[2]').get_attribute('outerHTML')
        # 打印爬取的HTML内容
        # print(a)
        # 解析返回内容
